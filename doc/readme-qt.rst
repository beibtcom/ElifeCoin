ElifeCoin-qt: Qt4 GUI for ElifeCoin
===============================
...
Alternatively, install Qt Creator and open the `ElifeCoin-qt.pro` file.

An executable named `ElifeCoin-qt` will be built.
...
A warning for people using the *static binary* version of ElifeCoin on a Linux/UNIX-ish system (tl;dr: **Berkely DB databases are not forward compatible**).

The static binary version of ElifeCoin is linked against libdb5.3.
...
installed causes ElifeCoin-qt to crash intermittently.  The issue has been reported as `launchpad bug 857790`_, but
isn't yet fixed.
