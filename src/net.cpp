...
static const char *strDNSSeed[][2] = {
    {"seed.elifecoin.org", "seed.elifecoin.org"},
	{"seed.elifecoin.com", "seed.elifecoin.com"},
...
void ThreadDNSAddressSeed(void* parg)
{
    ...
    RenameThread("ElifeCoin-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("ElifeCoin-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("ElifeCoin-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("ElifeCoin-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. ElifeCoin is probably already running."), addrBind.ToString().c_str());
        else
