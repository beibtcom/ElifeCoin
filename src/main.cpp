...
const string strMessageMagic = "ElifeCoin Signed Message:\n";
...
int64_t GetProofOfStakeReward(int64_t nCoinAge, unsigned int nBits, int64_t nTime, bool bCoinYearOnly)
{
	...
	else if (nTime < 1685998478)
		nRewardCoinYear = 5 * CENT;		
	else if (nTime < 1780692878)
		nRewardCoinYear = 4 * CENT;		
	else if (nTime < 1875387278)
		nRewardCoinYear = 3 * CENT;		
	else if (nTime < 1970081678)
		nRewardCoinYear = 2 * CENT;		
	else if (nTime < 2064689678)
...
void ThreadScriptCheck(void*) {
    ...
    RenameThread("ElifeCoin-scriptch");
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in ElifeCoin
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (fProofOfStake)
    {
        ...
        // ElifeCoin: check proof-of-stake block signature
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "ElifeCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1496695013;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 523531; // !fTestNet ? 1575379 : 46534;
...
unsigned char pchMessageStart[4] = { 0xb1, 0xf2, 0xc2, 0xe5 };
