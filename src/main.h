...
static const int LAST_POW_BLOCK = 30000; // P
...
static const uint256 hashGenesisBlock("0x000006217d0313c3de8d866235e7745c00cd6888b2cd9874dc298f836c377763");
...
public:
    ...
    {
        // Time based nLockTime implemented in ELC.6
        if (nLockTime == 0)
            return true;
        if (nBlockHeight == 0)
...
public:
    ...
    {
        // Protocol switch to support p2pool at ElifeCoin block #0
        ...
        // Before ElifeCoin block #0 - get from pregenerated table
